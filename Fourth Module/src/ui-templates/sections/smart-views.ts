...
> = (state) => {
  ...
  <bim-panel-section fixed label="Smart Views">
    <div style="display: flex; gap: 0.5rem;">
      <bim-text-input @input=${onSearch} placeholder="Buscar vistas..." debounce="200"></bim-text-input>
      ...
      <bim-button style="flex: 0" icon=${appIcons.ADD}>
        <bim-context-menu>
          <div style="display: flex; gap: 0.5rem;">
            ...
            <bim-button @click=${onCreateClick} style="flex: 0" label="Crear vista"></bim-button>
          </div>
        </bim-context-menu>
      </bim-button>
    </div>
